...
| 2026-02-22 | Security hardening (8 commits from Codex review): Auth enforcement on API/alerting routes, startup config hardening (production+staging), CORS credential fix, exception detail leakage removal (12 instances), notification result aggregation bug fix, duplicate index endpoint removal, rate limiter docs. RT-020–RT-026 (59 new regression tests). Total: 320 regression, 103 API, 105 alerting = 528 total. |
