...
| 2026-02-22 | Security hardening (11 commits from 2 Codex reviews): Auth enforcement on API/alerting routes, startup config hardening (production+staging), CORS credential fix, exception detail leakage removal (12 instances), notification result aggregation bug fix, duplicate index endpoint removal, rate limiter docs, auth enforcement in prod/staging, JWT error leakage fix, dev CORS wildcard fix. RT-020–RT-029 (75 new regression tests). Total: 336 regression, 103 API, 105 alerting = 544 total. |
